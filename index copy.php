...
<main>
    <section class="garden-banner">
        <div data-aos="fade-up" data-aos-duration="1000" class="banner-wrap">
            <div class="container">
                <div class="content">
                    <h1 class="text-white text-center mb-lg-4 mb-3">BGD Landscape - Thiết kế và thi công cảnh quan</h1>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div data-aos="fade-up-right" data-aos-duration="1000" class="video-wraper">
                            ...
                            <a data-fancybox data-src="https://www.youtube.com/watch?v=eiZ6Nr8lItk" data-caption="Câu chuyện ngắn về chúng tôi">
                        ...
                        <div class="col-3">
                            <div class="d-flex align-items-start">
                                <div class="nav flex-column nav-pills w-100 ">
                                    ...
                                    ?>
                                        <button class="nav-link <?php echo !$key ? 'active' : '' ?>" data-bs-toggle="pill" data-bs-target="#<?php echo  $term->slug ?>" aria-selected="true"><?php echo  $term->name ?></button>
                                    <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="col-9">
                            ...
                            <div class="tab-content">
                                <?php foreach ($terms as $key => $term) { ?>
                                    ...
                                    ?>
                                        <div class="col-12 "><a href="<?php echo get_term_link($child_id, $taxonomy_name) ?>"><button class="btn cate-item <?php echo $child_id == $term_current->term_id ? 'active' : '' ?>"><?php echo $term->name; ?>
                                                </button></a></div>
                                    <?php } ?>

                                    <div class="tab-pane fade show <?php echo !$key ? 'active' : '' ?>" id="<?php echo  $term->slug ?>">


                                        <div class="owl-carousel" data-autoheight="true" data-desktop="3" data-desktop-small="3" data-tablet="2" data-mobile="1" data-nav="true" data-dots="false" data-loop="true" data-autoplay="false" data-speed="500" data-autotime="4000">
                                            <?php
                                            $args = array(
                                                'post_type'         => 'post',
                                                'orderby'           => 'name',
            ...
            <div data-aos="fade-right" data-aos-duration="1000" class="section-title">
                ...
                <div class="d-flex justify-content-between">
                    <h2 class="section-title__name">DỰ ÁN CỦA CHÚNG TÔI<h2>
                            <a class="see-more fs-6" href="#">Tìm hiểu thêm <i class="ms-2 far fa-arrow-right"></i></a>
                </div>
            </div>
    ...
    <section class="garden-articles">
        ...
        <div class="garden-articles__news">
            <div class="container">
                <div class="owl-carousel " data-autoheight="true" data-desktop="4" data-desktop-small="3" data-tablet="3" data-mobile="1" data-nav="false" data-margintb="" data-dots="false" data-loop="true" data-autoplay="false" data-speed="500" data-autotime="4000">
                    <?php
                    $args = array(
                        'post_status'     => 'publish',
                        'post_type'       => 'post',
